...
<v-col cols="12">
  <v-card class="ma-0 pa-0">
    <div class="pa-0" style="background-color: #212121; width: 100%; box-sizing: border-box;">
      <div id="ad-container" class="d-flex justify-center align-center pa-0" style="width: 100%; box-sizing: border-box;">
